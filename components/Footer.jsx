...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-blue-700 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-10 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm text-white">{SITE.description}</p>
            <div className="mt-5 flex gap-3">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="grid h-9 w-9 place-items-center rounded-lg border border-brass-500/25 text-white hover:bg-brass-500 hover:text-navy-950 transition-colors focus-ring"
                >
                  <Icon size={16} />
                </a>
              ))}
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-brass-500/15 pt-6 text-sm text-white sm:flex-row sm:items-center sm:justify-between">
          <p>
...
function FooterCol({ title, links }) {
  return (
    <div>
      <h3 className="font-display text-lg font-bold text-brass-300">{title}</h3>
