    ...
    <>
      ...
      <section className="relative overflow-hidden bg-navy-950 pt-32 pb-16">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <nav aria-label="Breadcrumb" className="font-mono text-xs uppercase tracking-widest text-brass-300/80">
            ...
            <Link href="/blog" className="hover:text-brass-300">Blog</Link>
            <span className="mx-2">/</span>
            <span className="text-ivory-100/60">{post.category}</span>
          </nav>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-5 text-sm text-ivory-100/60">
            <span className="flex items-center gap-2">
              <Calendar size={16} className="text-brass-300" />
        ...
        <div className="grid gap-10 py-16 lg:grid-cols-4">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-28 rounded-xl2 border border-brass-500/20 bg-ivory-50 p-5">
              <p className="font-mono text-xs uppercase tracking-widest text-brass-600">On this page</p>
      ...
      <section className="bg-ivory-100 pb-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-xl2 bg-navy-950 px-8 py-12 text-center sm:px-16">
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-brass-500 px-6 py-3 font-semibold text-navy-950 shadow-glow hover:-translate-y-0.5 transition-transform focus-ring"
                >
